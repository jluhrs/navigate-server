...
const Web = Merge(
  ...
  parts.fontAssets,
  {
    mode: "development",
    entry: {
      engage: [path.resolve(parts.resourcesDir, "./dev.js")]
    },
    output: {
    ...
    // Custom dev server for the engage as we need a ws proxy
    devServer: {
      host: "0.0.0.0",
      hot: true,
...
if (isDevServer) {
  Web.entry.engage.push("webpack-dev-server-status-bar");
}

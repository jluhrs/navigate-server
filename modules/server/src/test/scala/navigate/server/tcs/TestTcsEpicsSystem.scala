...
object TestTcsEpicsSystem {
  ...
  def buildChannels[F[_]: Temporal](s: Ref[F, State]): TcsChannels[F] =
    TcsChannels(
      ...
      wavelPwfs1 = new TestChannel[F, State, String](s, Focus[State](_.rotMoveAngle)),
      wavelPwfs2 = new TestChannel[F, State, String](s, Focus[State](_.rotMoveAngle)),
      wavelOiwfs = new TestChannel[F, State, String](s, Focus[State](_.rotMoveAngle)),
